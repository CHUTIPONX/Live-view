...
const files=['server.mjs','lib/core.mjs','lib/handlers.mjs','lib/vercel.mjs','scripts-selftest.mjs','public/app.js','public/settings.js','public/login.js','api/login.js','api/logout.js','api/settings.js','api/shops.js','api/sales.js'];
let fail=false;
